...
### BLOCK DESIGN ###
#Data
parser.add_argument('-ed', '--eeg-dataset', default="data/eeg_55_95_std.pth", help="EEG dataset path") #55-95Hz
...
#Splits
parser.add_argument('-sp', '--splits-path', default="data/block_splits_by_image_all.pth", help="splits path") #All subjects
